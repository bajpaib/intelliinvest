...
//		stockSignalsBO.setSecurityId(quandlStockPrice.getSecurityId());
...
//		stockSignalsBO
//				.setAdxSignalPresent(IntelliinvestConstants.SIGNAL_NOT_PRESENT);
//
...
//		signalComponents.setSecurityId(quandlStockPrice.getSecurityId());
...
//		} else {
//			if (prevSignalComponents.getAdxSignal().equals(
//					IntelliinvestConstants.BUY)
//					|| prevSignalComponents.getAdxSignal().equals(
...
//			}
//		}
//		signalComponents.setAdxSignal(signal);
//
//		String signalPresent = IntelliinvestConstants.SIGNAL_NOT_PRESENT;
//		signalComponents.setAdxSignalPresent(signalPresent);
...
//						.getAdxSignal().equals(IntelliinvestConstants.HOLD))) {
...
//						.getAdxSignal().equals(IntelliinvestConstants.WAIT))) {
//			signalPresent = IntelliinvestConstants.SIGNAL_NOT_PRESENT;
