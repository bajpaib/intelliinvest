...
public class NeuralNetworkStockPredictor {
	...
	private String learningDataFilePath = "C:\\data\\learningData.csv";
	private String neuralNetworkModelFilePath = "C:\\data\\stockPredictor.nnet";

	public static void main(String[] args) throws IOException {

		NeuralNetworkStockPredictor predictor = new NeuralNetworkStockPredictor(5, "C:\\data\\rawTrainingData.csv");
	...
	void trainNetwork() throws IOException {
		NeuralNetwork<BackPropagation> neuralNetwork = new MultiLayerPerceptron(TransferFunctionType.SIGMOID,slidingWindowSize,
